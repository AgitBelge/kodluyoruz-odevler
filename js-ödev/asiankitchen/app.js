...
buttonJapan.classList.add('btn','btn-outline-warning','btn-item');
...
buttonKorea.classList.add('btn', 'btn-outline-success','btn-item');
buttonKorea.setAttribute('type','button');
container.appendChild(buttonKorea);

const buttonChine = document.createElement('button');
buttonChine.textContent = 'Chine';
buttonChine.classList.add('btn', 'btn-outline-danger', 'btn-item');
container.append(buttonChine);
...
buttonChine.addEventListener("click", () => eventHandler("China"));
